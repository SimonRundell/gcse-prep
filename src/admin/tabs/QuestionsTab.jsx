 ...
 * @description CRUD interface for the question bank.
 */
        ...
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                <div>
                    ...
                    <span style={{ color: 'var(--slate)', marginLeft: 8, fontSize: '.82rem' }}>{rows.length} questions</span>
                </div>
            ...
            {loading
                ...
                : (
                    <table className="admin-table">
                        <thead>
                            <tr><th>Slot</th><th>Topic</th><th style={{ width: 300 }}>Question</th><th>Marks</th><th>Actions</th></tr>
                        </thead>
                        <tbody>
                            {visible.map(r => (
                                <tr key={r.id}>
